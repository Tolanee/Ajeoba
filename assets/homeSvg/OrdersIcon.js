...
export default function OrdersIcon({color}){
    return(
        <Svg width="25" height="24" viewBox="0 0 25 24" fill={color} xmlns="http://www.w3.org/2000/svg">
            ...
            <Path d="M9.5 9.01001H12.5" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            <Path d="M6.49561 13H6.50459" stroke="#292D32" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <Path d="M6.49561 9H6.50459" stroke="#292D32" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </Svg>
    )
}
