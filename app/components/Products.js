  ...
  return (
    ...
    >
      <View className="w-full">
        <Image
          source={each.image}
          className="my-3 w-full h-[100px]  rounded-lg"
        />
        <Text style={{ fontFamily: "Poppins-Regular" }} className="text-sm">
          {each.name}
        </Text>
        ...
        return (
          <View key={index} className="">
            <View className="flex flex-row justify-between bg-lightGreen p-4 items-center">
              ...
              <TouchableOpacity className="bg-white  border-2  border-primary rounded-lg p-2 items-center">
                <Text
                  style={{ fontFamily: "Poppins-SemiBold" }}
            ...
            <View className=" py-5 mb-5 bg-white ">
              <FlatList
                ...
                data={all.eachProducts}
                renderItem={({ item }) => productScroll(item, all.name)}
              />
            </View>
          </View>
        );
