        ...
        <View className="m-3 flex-1">
          ...
          >
            <View className="px-5">
              ...
              <View className="flex flex-row justify-between items-center pb-3  border-b border-1 border-[#F1F1F1]">
                <Text
                  style={{ fontFamily: "Poppins-Regular" }}
                  className="text-sm text-lightGray"
                >
                  Seller:{" "}
                  <Text className="text-sm text-darkGray">{seller}</Text>{" "}
                </Text>
            ...
            <View className="bg-lightGreen">
              <View className="flex flex-row space-x-1 items-center  p-5">
                ...
                <Text
                  ...
                  className="italic text-lightGray"
                >
                  (Per ton)
                </Text>
              </View>
          ...
          <View>
            ...
            <View
              style={{ elevation: 8 }}
              className="bg-white rounded-lg border-2 border-[#F1F1F1] shadow-xl p-5 "
            >
              <View>
                <Text
                  style={{ fontFamily: "Poppins-Medium" }}
                  className="text-[#004D24] text-sm font-bold"
                >
